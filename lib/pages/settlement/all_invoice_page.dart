                    ...
                    children: [
                      ...
                      Wrap(
                        children: [
                          ...
                          Text(
                            "${model.settlementInvoiceList[index].amount} 元",
                            style: TextStyle(
                              fontSize: 18,
                      ...
                      Wrap(
                        children: [
                          ...
                          Text(
                            "${model.settlementInvoiceList[index].tax} 元",
                            style: TextStyle(
                              fontSize: 18,
                              color: TTMColors.titleColor,
                              fontWeight: FontWeight.bold,
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  "付款方：${model.settlementInvoiceList[index].payer.companyName}",
                                ...
                                Text(
                                  "收款方：${model.settlementInvoiceList[index].driver.name}",
                                  style: TTMTextStyle.wayBillCellDetailLabel,
                                  softWrap: true,
                                  overflow: TextOverflow.fade,
                                ),
                                ...
                                Text(
                                  "创建时间:     ${DateUtil.parseStringToFormateString(model.settlementInvoiceList[index].dateCreated ?? "")}",
                                  style: TTMTextStyle.wayBillCellDetailLabel,
                                  softWrap: true,
                                  overflow: TextOverflow.fade,
                                ),
