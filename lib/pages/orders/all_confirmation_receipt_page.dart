                ...
                children: [
                  ...
                  Wrap(
                    children: [
                      ...
                      Text(
                        "${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.price.toString()} 元",
                        style: TextStyle(
                          fontSize: 18,
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "装货地址: ${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.pickupProvince.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.pickupCity.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.pickupArea.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.pickupAddress}",
                            ...
                            Text(
                              "卸货地址: ${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receivingProvince.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receivingCity.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receivingArea.name}-${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receiving_address}",
                              style: TTMTextStyle.wayBillCellDetailLabel,
                              softWrap: true,
                              overflow: TextOverflow.fade,
                            ),
                            ...
                            Text(
                              "收货人:     ${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receivingName}",
                              style: TTMTextStyle.wayBillCellDetailLabel,
                              softWrap: true,
                              overflow: TextOverflow.fade,
                            ),
                            ...
                            Text(
                              "联系方式: ${model.wayBillConfirmationReceiptlist[index].orderCarrier.intention.demand.receivingTel}",
                              style: TTMTextStyle.wayBillCellDetailLabel,
                              softWrap: true,
                              overflow: TextOverflow.fade,
                            ),
